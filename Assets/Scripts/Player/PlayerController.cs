...
public class PlayerController : MonoBehaviour
{
    ...
    [Header("Ground Check")]
    public Transform groundCheck;           // Un objeto vac�o a los pies que sirve para comprobar si el personaje est� en el suelo.
    ...
    Vector2 moveInput;
    Vector3 velocity;
    bool isWalking;                         // C�mo lo general es que corra... Pues que lo haga autom�tico y que el jugador decida si quiere andar
    ...
    void Update()
    {
        // [!] A lo mejor es por estar aqu� desde las 5AM, pero no logro hacer que lo de el mantener el bot�n funcione de otra forma. Voy a comprobar aqu� si est� pulsado y preguntar luego.........
